...
public class CarController {
    ...
    @GetMapping("/car")
    public String getCar(@RequestParam(value = "count", required = false) String name, ModelMap model) {
        ...
        model.addAttribute("cars", (name != null) ? cars
                .stream()
                .limit(Integer.parseInt(name))
                .toList() : cars);
        return "car";
    }
}
